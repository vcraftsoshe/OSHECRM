...
async function downloadBuildPdf({ client, category, categoryKey, included, documentTemplates }) {
  ...
  for (let idx = 0; idx < included.length; idx++) {
    ...
    const drawProcHeader = (pg) => {
      ...
      const titleSize = 17;
      pg.drawText(label, { x: margin, y: pageHeight - bandHeight / 2 - titleSize / 3, size: titleSize, font: boldFont, color: rgb(1, 1, 1) });
    };
    drawProcHeader(page);
    ...
    // Real reference diagrams are appended at the end of each procedure as their own
    // labelled appendix pages, rather than hand-drawn and interleaved with the body text.
    ...
    if (label === "Hazard & Risk Management Procedure") {
      ...
      await drawAppendix("Risk Matrix", "risk-matrix.png");
      await drawAppendix("Hierarchy of Controls", "hierarchy-of-controls.png");
      await drawAppendix("Managing Risks and Hazards", "managing-risks-hazards-cycle.png");
    ...
    if (label === "Hazardous Substances Procedure") {
      await drawAppendix("Hazard Classification Symbols (1 of 2)", "hazard-symbols-1.png");
      await drawAppendix("Hazard Classification Symbols (2 of 2)", "hazard-symbols-2.png");
    }
