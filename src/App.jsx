...
export default function App() {
  ...
  useEffect(() => {
    const realProcedureContent = {
      ...
      "Induction & Training Procedure": "The Company is committed to ensuring all workers are inducted and trained to perform their duties safely, protecting them from injury and health risks at work. Induction provides essential information and training to workers, contractors, labour-hire workers, volunteers, and visitors before they undertake any work or face any health, safety, or welfare risk, and applies to new or transferred workers across all sites, implemented prior to any work commencing.\n\nRoles & Responsibilities: Managers/Supervisors conduct inductions and maintain induction records. Workers, contractors, labour hire workers, volunteers, and visitors ensure their actions don't endanger themselves or others, actively participate in the induction, and comply with The Company's policies and procedures.\n\nOnboarding Process — Day One: employment contract signed and returned, licenses and training certificates collected, bank and next-of-kin details obtained, absence and other employment policies reviewed, site security/entry/exit procedures and attendance recording explained, and any special medical needs (e.g. asthma, diabetes) documented and passed to the first aider.\n\nInduction & Orientation Program covers: incident and accident reporting (including notifiable events and near-miss reporting); health and safety responsibilities; hazard identification and risk management training, with competency confirmed before sign-off; and general health and safety information — the manual and policies, worker participation and leave requirements, the buddy program, PPE issuance and training, emergency procedures, mobile phone use while driving, and reporting forms and documentation.\n\nExisting Training: Upon employment, each worker's existing qualifications and experience are assessed, matched to the training register, and any additional required training is organised.\n\nCompetence: The Company determines and ensures competency based on education, induction, and training, retaining documentation as evidence. Annual training plans support ongoing development, and workers are competency-assessed before unsupervised equipment use.\n\nSpecial Needs: The Company considers the special needs of new workers, contractors, labour hire workers, volunteers, and visitors — written materials may be translated or simplified, with further assistance provided if needed.\n\nManagement of Young and Vulnerable Workers: The Company provides additional guidance and supervision for young and vulnerable workers, including a tailored induction with extra focus on hazards, emergency procedures, and safety policies; a buddy program pairing them with an experienced worker; ongoing supervision with regular manager check-ins; and clear reporting mechanisms encouraging them to raise concerns without hesitation.\n\nTransferring Workers: When transferring workers to new tasks or departments, they receive a specific induction covering risks associated with the new role and environment.\n\nRefresher and Planned Training: All training records are logged in the Training & Competency Register. The Company administrator monitors certification expiry dates, arranging refresher training as needed and scheduling additional training based on role requirements.\n\nRecord Maintenance: Induction records for workers, contractors, labour hire workers, volunteers, and visitors are maintained for five years.",
      "PPE Procedure": "The purpose of this procedure is to define the requirements, responsibilities, and practices for the use of personal protective equipment (PPE) whenever it has been identified as a risk control measure. It applies to all PPE used in The Company.\n\nHazard Identification and Risk Assessment: The Company completes a risk assessment of all work in consultation with workers, recorded in the Hazard Register. Hazard identification takes place when new plant/equipment or tasks are introduced, for existing plant and equipment, before changes to a system of work, before plant is used outside its designed purpose, or when new safety information becomes available.\n\nRisk Management: The hierarchy of controls is applied — risk is eliminated where reasonably practicable, or otherwise minimised using the hierarchy. PPE is only used when there are no other practical control measures available (as a last resort), as an interim measure until a more effective control can be used, or to supplement higher-level controls.\n\nSelection of PPE: PPE must be appropriate to the task and level of risk, used in every situation where a risk assessment or safe work procedure identifies the need, selected/used/maintained in accordance with relevant legislation, AS/NZS standards, and manufacturer's instructions, and fitted to the individual user. Proof of AS/NZS compliance is a prerequisite for purchase.\n\nUse of PPE: Correct fit is essential and must be checked by the user before use — where RPE is issued, a quantitative fit test by a qualified external provider is arranged annually. Workers and visitors are instructed in the correct use of PPE, including why it's needed, its basic design and limitations, and PPE requirements are incorporated into inductions.\n\nMaintenance: All PPE is maintained, tested, and stored per the manufacturer's requirements, kept clean and hygienic, and damaged PPE is repaired or replaced.\n\nIssuing: PPE is made available to all workers, volunteers, and visitors when required — independent contractors and subcontractors are required to provide their own PPE.\n\nReview and Evaluation: Users inspect PPE regularly for deterioration, missing or damaged parts, and expiry — PPE must not be used in sub-standard condition, and faulty, damaged, or excessively worn PPE is withdrawn from use immediately and replaced.\n\nResponsibilities: The PCBU (The Company) ensures this procedure is implemented and that sufficient resources are provided for PPE. Managers & Supervisors ensure appropriate PPE selection, correct use through training and supervision, proper cleaning/maintenance/storage, scheduled inspections, and timely replacement — while leading by example. Workers avoid placing themselves or others at risk, wear and use PPE as required, participate in PPE selection and training, and raise concerns without fear of reprisal. Visitors and others avoid placing themselves or others at risk and use and look after PPE provided.\n\nReplacement/Monitoring/Issuing: PPE requirements are reviewed annually, or sooner following an incident investigation or a change to work tasks or processes. All required PPE is issued at induction and recorded in the PPE register. Workers needing replacement PPE before expiry use the Request PPE form in the HARM App. Workers are also asked weekly at toolbox meetings whether they need additional PPE, recorded for action.",
    };
